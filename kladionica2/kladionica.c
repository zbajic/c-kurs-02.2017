...
void* Punjenje_bafera(void* pParam) {
	...
	while (1) {
		...
		trka konacni_rezultati[9] = { { 'B', "10.05.2017", { "auto 1", "auto 2",
				"auto 7", "auto 4", "auto 8", "auto 3", "auto 5", "auto 9",
				"auto 6", "auto 10" } }, { 'A', "11.03.2017", { "konj 5",
				"konj 3", "konj 7", "konj 1", "konj 10", "konj 4", "konj 5",
				"konj 6", "konj 8", "konj 9" } }, { 'B', "02.09.2017", {
				"auto 3", "auto 9", "auto 5", "auto 1", "auto 2", "auto 4",
				"auto 8", "auto 6", "auto 7", "auto 10" } }, { 'B',
				"23.07.2017", { "auto 6", "auto 2", "auto 7", "auto 4",
						"auto 8", "auto 3", "auto 5", "auto 9", "auto 1",
						"auto 10" } }, { 'A', "16.01.2017", { "konj 4",
				"konj 3", "konj 7", "konj 1", "konj 10", "konj 7", "konj 5",
				"konj 6", "konj 8", "konj 9" } }, { 'B', "25.12.2017", {
				"auto 8", "auto 9", "auto 5", "auto 1", "auto 2", "auto 4",
				"auto 3", "auto 6", "auto 7", "auto 10" } }, { 'B',
				"04.04.2017", { "konj 7", "konj 9", "konj 5", "konj 1",
						"konj 10", "konj 4", "konj 5", "konj 6", "konj 8",
						"konj 3" } } };
		...
		if (sem_trywait(&br_slobodnih_mjesta)) {
			...
			for (i = 0; i < 7; i++) {
				...
				pthread_mutex_lock(&pristup_baferu);
				put(&buffer, konacni_rezultati[i]);
				pthread_mutex_unlock(&pristup_baferu);
