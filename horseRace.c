...
int make_step(short fitness) //parameter fitness for making step. enter vaulues: 7,8,9 or 10   >>TESTED OK<<
{
   short r_number;
   short low = 6;
   short high = 11;
   ...
   return r_number / 10; // divided with 10 for testing purpose
}
